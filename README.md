...
4. **Add Shuffle Integration**: Add the [integration](https://wazuh.com/blog/integrating-wazuh-with-shuffle/#integration-steps) tag into the Wazuh configuration file.
